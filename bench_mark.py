...
def bench_mark(iteration=5, n=[10, 100, 1000, 5000]):
    ...
    def _show_average():
        ...
        print("\n" + 42 * "=" + " AVERAGE " + 42 * "=")
        print(" Size      Tim          Quick        Merge        Selection    Insertion    Bubble")
        print(93 * "-")
        ...
        for i, size in enumerate(n):
            ...
            col7_spacing = 13 - len(ave_t_tim)
            col6_spacing = 13 - len(ave_t_quick)
            col2_spacing = 13 - len(ave_t_selection)
            col3_spacing = 13 - len(ave_t_merge)
            col4_spacing = 13 - len(ave_t_insertion)
            col5_spacing = 13 - len(ave_t_bubble)

            print(
                f" {size}{col1_spacing * ' '}{ave_t_tim}{col7_spacing * ' '}{ave_t_quick}{col6_spacing * ' '}{ave_t_merge}{col3_spacing * ' '}{ave_t_selection}{col2_spacing * ' '}{ave_t_insertion}{col4_spacing * ' '}{ave_t_bubble}{col5_spacing * ' '}")
    ...
    for rep in range(iteration):
        ...
        print("\n Iteration #", rep + 1)
        print("\n Size      Tim          Quick        Merge        Selection    Insertion    Bubble")
        print(93 * "-")
        ...
        for i, size in enumerate(n):
            ...
            col1_spacing = 10 - len(str(size))
            col7_spacing = 13 - len(t_tim)
            col6_spacing = 13 - len(t_quick)
            ...
            print(f" {size}{col1_spacing * ' '}{t_tim}{col7_spacing * ' '}{t_quick}{col6_spacing * ' '}{t_merge}{col3_spacing * ' '}{t_selection}{col2_spacing * ' '}{t_insertion}{col4_spacing * ' '}{t_bubble}{col5_spacing * ' '}")
